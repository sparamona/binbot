...
If there are multiple items, include each one as a separate object in the "items" array."""
    ...
    def compare_items(self, image_path1: str, image_path2: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if not base64_image1 or not base64_image2:
                return {"success": False, "error": "Failed to encode images"}
                
            prompt = """Compare these two images and determine if they show the same item or similar items. Please provide:

1. Are these the same item? (yes/no)
2. Similarity score (0-10, where 10 is identical)
3. Key differences (if any)
4. Confidence in your assessment (1-10)
...
Respond in JSON format:
{
    ...
    "explanation": "brief explanation of your assessment"
            ...
            return {
                "success": False,
                "error": f"Vision comparison error: {str(e)}"
            }
